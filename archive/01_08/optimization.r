...
weights<-function(ins) {
    ...
    #setwd("C:/Users/EDZ/Desktop/ç†äº«å®?/Portfolio_Proj") #can be specified
    ...
    selected <- data[,(fund_num_tmp*(ins-1)+1+1):(fund_num_upper+1)] #first plus oneï¼? begin with 6-10; second plus one: first column of data is date 

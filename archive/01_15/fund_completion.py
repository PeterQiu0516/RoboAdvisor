...
def seven(data):
    ...
    if (type(data_date_tmp[2]) == type("aha")):
    ...
    if (type(fund_1.iloc[1, 0]) == type("aha")):
    ...
    if (type(fund_2.iloc[1, 0]) == type("aha")):
...
def weights(data):
    ...
    ef = EfficientFrontier(mu, S,weight_bounds=(0.1,0.7))
